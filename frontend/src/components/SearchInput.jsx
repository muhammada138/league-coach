                ...
                >
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-all duration-200">
                    <button
                      ...
                      className={`w-7 h-7 rounded-lg flex items-center justify-center transition-all outline-none focus-visible:ring-2 focus-visible:ring-[#c89b3c]/50
                        ${s.isSaved
                    ...
                    <button
                      ...
                      className="w-7 h-7 rounded-lg flex items-center justify-center text-red-500/30 hover:text-red-500 hover:bg-red-500/10 transition-all outline-none focus-visible:ring-2 focus-visible:ring-red-500/50"
