    ...
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {pill ? (
        <button
          ...
          aria-label={`Select region, currently ${activeRegion.label}`}
          className={`flex items-center gap-1.5 pl-3.5 pr-2.5 h-full transition-all rounded-l-xl
            ...
            focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c89b3c]/50 focus-visible:z-10
            group select-none`}
        >
        ...
        <button
          ...
          aria-haspopup="listbox"
          aria-label={`Select region, currently ${activeRegion.label}`}
          className={`flex items-center gap-2 group transition-all duration-200 outline-none focus-visible:ring-2 focus-visible:ring-[#c89b3c]/50 focus-visible:z-10
            ${compact 
              ? "h-full px-2" 
